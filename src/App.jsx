    ...
    try {
        ...
        autoTable(doc, { 
            ...
            didDrawPage: function (data) {
                ...
                const freightColumn = table.columns[6];

                doc.setFont("helvetica", "bold"); 
                doc.text("TOTAL", freightColumn.x - 5, finalY + 7, { align: "right" }); 
                doc.text(formatIndianCurrency(bill.totalAmount), freightColumn.x + freightColumn.width - 2, finalY + 7, { align: "right" }); 
